...
chromedriver_path = 'D:/os/chromedriver.exe' # Change this to your own chromedriver path!
...
username.send_keys('chiefq_')
password = webdriver.find_element_by_name('password')
password.send_keys('kirianiboys')
...
#next
hashtag_list = ['photography', 'potraitphotography', 'moodyshots']
